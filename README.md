...
## ros 🟰 Best ❄️ NixOS Configs

ros is a simple way of reproducing my configuration on any NixOS system. This includes the wallpaper, scripts, applications, config files, and more.

<img align="center" width="80%" src="https://raw.githubusercontent.com/aarjaycreation/ros/master/config/demo.png" />    

**Inspiration for the Waybar config [here](https://github.com/justinlime/dotfiles).**

</div>

> **This project has a [Wiki](https://aarjaycreation.com/). Find out how to use ros here!**
> **I have put a lot of effort into the [documentation](https://aarjaycreation.com/) so it should be accurate. However, please if you notice that something is wrong with it create an issue or reach out to me on Discord.**

#### 🍖 Requirements
- You must be running on NixOS.
- The ros folder (this repo) is expected to be in your home directory.
...
- The entire idea of ros is to make NixOS an approachable space that is actually a great community that you want to be in.
- Many people who are patient and happy to spend their free time helping you are running ros. Feel free to reach out on the Discord for any help with anything.
...
- Contact me on [portfolio](https://aarjaycreation.com/) as well, for a potentially faster response.
...
sh <(curl -L https://raw.githubusercontent.com/aarjaycreation/ros/master/install-ros.sh)
```
...
```
git clone https://github.com/aarjaycreation/ros
cd ros
```
